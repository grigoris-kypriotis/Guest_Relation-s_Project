...
class GuestRelationApp(QMainWindow):
    def __init__(self):
        ...
        for key in ["CONFIG", "MANIFEST", "STATS", "PLOT", "MOVES", "TODO", "OFFERS",
        ...
        # -----------------------------------------------------------------
        self.config_widget.data_updated.connect(self.stats_widget.reset_traces)
        ...
        self.add_log("All Activity", "Application initialized and ready. Live Config mounted.", "INFO")
