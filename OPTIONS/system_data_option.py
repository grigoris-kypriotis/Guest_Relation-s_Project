    ...
    def _apply_filter(self) -> None:
        ...
        for r in range(total_rows):
            ...
            if block_selection != "All Rooms / Blocks":
                if "Block 100s" in block_selection:
                    block_match = room_val.startswith("1") and len(room_val) == 3
                elif "Block 200s" in block_selection:
                    block_match = room_val.startswith("2") and len(room_val) == 3
                elif "Block 300s" in block_selection:
                    block_match = room_val.startswith("3") and len(room_val) == 3
                elif "Block 400s" in block_selection:
                    block_match = room_val.startswith("4") and len(room_val) == 3
                elif "Block 500s" in block_selection:
                    block_match = room_val.startswith("5") and len(room_val) == 3
                elif "Block 600s" in block_selection:
                    block_match = room_val.startswith("6") and len(room_val) == 3
                elif "Block 700s" in block_selection:
                    block_match = room_val.startswith("7") and len(room_val) == 3
                elif "Block 800s" in block_selection:
                    block_match = room_val.startswith("8") and len(room_val) == 3
                elif "Block 1100s" in block_selection:
