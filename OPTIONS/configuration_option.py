...
class ConfigurationWidget(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        # -----------------------------------------------------------------
        card_storage = self._create_card("\U0001f4e6 DOCUMENT STORAGE LOCATIONS", accent_color="#2563EB")
        ...
        self.lbl_storage_summary.setStyleSheet("color: #2563EB; font-size: 11px; font-weight: bold; padding-top: 4px; border: none;")
